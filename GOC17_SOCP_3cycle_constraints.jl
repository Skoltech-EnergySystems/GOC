...
# q13 constraints
@constraint(PSCOPF, q13L[i = 1:cycle3_size, k=1:NK], (-0.21) * c[cycle3list[i][3],cycle3list[i][3],k]
+ c[cycle3list[i][2],cycle3list[i][3],k] * (-0.21)
+ (-0.21) * c[cycle3list[i][3],cycle3list[i][1],k] <= 0);

@constraint(PSCOPF, q13U[i = 1:cycle3_size, k=1:NK], (0.21) * c[cycle3list[i][3],cycle3list[i][3],k]
+ c[cycle3list[i][2],cycle3list[i][3],k] * (0.21)
+ (0.21) * c[cycle3list[i][3],cycle3list[i][1],k] >= 0);

# q23 constraints
@constraint(PSCOPF, q23L[i = 1:cycle3_size, k=1:NK], c[cycle3list[i][1],cycle3list[i][2],k] * c[cycle3list[i][3],cycle3list[i][3],k]
- c[cycle3list[i][2],cycle3list[i][3],k] * c[cycle3list[i][3],cycle3list[i][1],k]
+ (-0.21) * c[cycle3list[i][3],cycle3list[i][1],k] <= 0);

@constraint(PSCOPF, q23U[i = 1:cycle3_size, k=1:NK], c[cycle3list[i][1],cycle3list[i][2],k] * c[cycle3list[i][3],cycle3list[i][3],k]
- c[cycle3list[i][2],cycle3list[i][3],k] * c[cycle3list[i][3],cycle3list[i][1],k]
+ (0.21) * c[cycle3list[i][3],cycle3list[i][1],k] >= 0);
