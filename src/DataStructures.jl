...
function constr_PNetworkData(PND)
    ...
    # LINE
    line = DataFrame(I=Int[], J=Int[], CKT=String[], R=Float16[], X=Float16[], B=Float16[], RATEA=Float16[], RATEB=Float16[], RATEC=Float16[], GI=Float16[], BI=Float16[], GJ=Float16[], BJ=Float16[], ST=Bool[], MET=Float16[], LEN=Float16[], O1=Float16[], F1=Float16[], O2=Float16[], F2=Float16[], O3=Float16[], F3=Float16[], O4=Float16[], F4=Float16[])
    #
    PND.line = line
